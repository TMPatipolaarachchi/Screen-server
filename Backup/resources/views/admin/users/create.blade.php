                    ...
                    <form method="POST" action="{{ route('admin.users.store') }}">
                        ...
                        <div class="mb-3">
                            ...
                            >
                                ...
                                <option value="user1" @selected(old('role') === 'user1')>User 1</option>
                                <option value="user2" @selected(old('role') === 'user2')>User 2</option>
                                <option value="user3" @selected(old('role') === 'user3')>User 3</option>
                            </select>
                            @error('role')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
